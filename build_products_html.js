...
const products = [
  ...
  // Switches
  { category: 'switches', name: '2 MODULAR BOX', icon: '💠', image: '2-modular-box.webp', desc: 'Premium quality 2-module switchboard mounting metal box made of galvanized steel for rust resistance.' },
  { category: 'switches', name: '3 MODULAR BOX', icon: '💠', image: '3-modular-box.webp', desc: 'Robust 3-module galvanized iron modular mounting box with standard threads for modular switch plates.' },
  { category: 'switches', name: '4 MODULAR BOX', icon: '💠', image: '4-modular-box.webp', desc: 'Galvanized 4-module switch box, durable and corrosion-resistant for concealed wiring setups.' },
  { category: 'switches', name: '6 MODULAR BOX', icon: '💠', image: '6-modular-box.webp', desc: 'Galvanized steel 6-module mounting box, engineered for standard switches and power outlets.' },
  ...
  { category: 'switches', name: '8 MODULAR BOX', icon: '💠', image: '8-modular-box.webp', desc: 'Standard rectangular 8-module galvanized switch box for heavy home appliances and multiple points.' },
  { category: 'switches', name: '12 MODULAR BOX', icon: '💠', image: '12-modular-box.webp', desc: 'Spacious 12-module galvanized modular switchboard box for complete room control and panel distribution.' },
  { category: 'switches', name: 'Socket', icon: '🔌', image: 'modular-socket.webp', desc: 'ISI-marked heavy duty modular power socket with safety shutters and high-grade flame retardant polycarbonate body.' },
  ...
  { category: 'conduit', name: 'INDEANA PIPE 20MM MEDIUM', icon: '🧰', image: 'indeana-pipe-20mm-medium.webp', desc: 'Medium-duty 20mm PVC conduit pipe by Indeana, flexible and robust for concealed ceiling and wall installations.' },
  ...
  { category: 'conduit', name: 'INDEANA BAND 25MM', icon: '🧰', image: 'indeana-band-25mm.webp', desc: 'Robust 25mm PVC bend/band by Indeana, designed for smooth pulling of wires without damage at corners.' },
  { category: 'conduit', name: 'INDEANA BAND 20MM MEDIUM', icon: '🧰', image: 'indeana-band-20mm-medium.webp', desc: 'Medium-duty 20mm PVC bend for connecting wall conduits seamlessly at right angles.' },
  ...
  { category: 'conduit', name: 'CONCIELD BOX HEAVY', icon: '🧰', image: 'concealed-box-heavy.webp', desc: 'Heavy-duty concealed ceiling junction box for neat wiring connections and profile lights.' },
  ...
  { category: 'conduit', name: 'CONCIELD MEDIUM', icon: '🧰', image: 'concealed-box-medium.webp', desc: 'Concealed medium-duty wall junction box, flame-retardant and durable.' },
  { category: 'conduit', name: 'FLEXIBLE PIPE 20MM', icon: '🧰', image: 'flexible-pipe-20mm.webp', desc: 'Corrugated 20mm PVC flexible pipe, perfect for linking main conduits to switch boards around pillars.' },
  { category: 'conduit', name: 'FAN ROD 12 INCH', icon: '🧰', image: 'fan-rod-12-inch.webp', desc: 'Heavy iron ceiling fan downrod (12 inches) with rust-resistant paint and secure key bolt slots.' },
  { category: 'conduit', name: 'TEE COVER', icon: '🧰', image: 'tee-cover.webp', desc: 'Standard PVC Tee cover for securing T-junction connections of surface wiring casing/pipes.' },
  ...
  { category: 'conduit', name: 'Fan box light 500G', icon: '🧰', image: 'fan-box-light-500g.webp', desc: 'Premium 500g heavy duty galvanized steel fan box, built for maximum structural safety.' },
  ...
  { category: 'hardware', name: 'SCREW 1 INCH', icon: '🔧', image: 'screw-1-inch.webp', desc: 'Threaded 1-inch metal screws, durable and rust-resistant for secure electrical hardware mounting.' },
  ...
  { category: 'hardware', name: 'SCREW 2 INCH', icon: '🔧', image: 'screw-2-inch.webp', desc: 'High-tensile 2-inch screws, perfect for deep wall plug anchorage and heavy fixtures.' },
  ...
  { category: 'hardware', name: 'MASKING TAPE', icon: '🔧', image: 'masking-tape.webp', desc: 'High-adhesion masking tape for site painting protection and structural marking.' },
  ...
  { category: 'hardware', name: 'SELF DRILLING SCREW 2 INCH', icon: '🔧', image: 'self-drilling-screw-2-inch.webp', desc: 'Heavy-duty 2-inch self-drilling metal screws for thick sheets and frames.' },
  { category: 'hardware', name: 'HEATEX 5 KG', icon: '🔧', image: 'heatex-5kg.webp', desc: 'High-grade Heatex adhesive / seal bond compound (5 Kg bucket) for construction joints.' },
  { category: 'hardware', name: 'KEEL 1*14 SPN', icon: '🔧', image: 'keel-1x14-spn.webp', desc: 'Standard 1x14 concrete nails / keels for fast ceiling and wall anchoring.' },
  { category: 'hardware', name: 'KEEL 1.5*14 SPN', icon: '🔧', image: 'keel-1-5x14-spn.webp', desc: 'High-strength 1.5x14 concrete nails for conduit clips and wiring casing anchoring.' },
  { category: 'hardware', name: 'KEEL 2*14 SPN', icon: '🔧', image: 'keel-2x14-spn.webp', desc: 'Heavy-duty 2x14 concrete nails for structural frames, brackets, and clamp mounting.' },
  { category: 'hardware', name: 'WALL FIX BOND 50G', icon: '🔧', image: 'wall-fix-bond-50g.webp', desc: 'Rapid curing Wall Fix adhesive bond (50g tube) for quick panel and channel fixing.' },
  { category: 'hardware', name: 'WALL FIX BOND 18G', icon: '🔧', image: 'wall-fix-bond-18g.webp', desc: 'Compact Wall Fix adhesive bond (18g tube) for minor repairs and quick hardware locking.' },
  { category: 'hardware', name: 'ARALDITE 1.8KG', icon: '🔧', image: 'araldite-1-8kg.webp', desc: 'Industrial grade Araldite epoxy adhesive pack (1.8 Kg), ultra-strong bonding strength.' },
  { category: 'hardware', name: 'ZYPSEM SCREW 3/4 WHITE', icon: '🔧', image: 'zypsem-screw-3-4-white.webp', desc: 'Premium white Zypsem drywall screws (3/4 inch) for dry partition board wiring setups.' },
  { category: 'hardware', name: 'WOOD CUTTER BLADE 5/30 BOSCH', icon: '🔧', image: 'wood-cutter-blade-5-30-bosch.webp', desc: 'Genuine 5-inch 30-teeth wood cutter circular saw blade by Bosch. Ultra-sharp teeth for clean cuts.' },
  { category: 'hardware', name: 'WOOD CUTTER BLADE 4/30 BOSCH', icon: '🔧', image: 'wood-cutter-blade-4-30-bosch.webp', desc: 'Genuine 4-inch 30-teeth wood cutter circular saw blade by Bosch, engineered for high RPM.' },
  { category: 'hardware', name: 'WALL CUTTER BLADE 4 INCH BOSCH', icon: '🔧', image: 'wall-cutter-blade-4-inch-bosch.webp', desc: 'Genuine 4-inch Bosch wall cutter diamond blade for concrete grooving and pipe slot casing.' },
  { category: 'hardware', name: 'WALL CUTTER BLADE 5 INCH BOSCH', icon: '🔧', image: 'wall-cutter-blade-5-inch-bosch.webp', desc: 'Genuine 5-inch Bosch concrete grooving diamond blade, heavy duty for structural work.' },
  { category: 'hardware', name: 'SATTRING KEEL 1 INCH', icon: '🔧', image: 'sattring-keel-1-inch.webp', desc: 'Standard 1-inch shuttering concrete keels/nails for wooden structuring and support.' },
  { category: 'hardware', name: 'SATTRING KEEL 2 INCH', icon: '🔧', image: 'sattring-keel-2-inch.webp', desc: 'Heavy 2-inch shuttering concrete nails for frame support and conduit pipe anchoring.' },
  { category: 'hardware', name: 'SATTRING KEEL 3 INCH', icon: '🔧', image: 'sattring-keel-3-inch.webp', desc: 'Heavy-duty 3-inch shuttering nails for heavy structural frames and timber support.' },
  { category: 'hardware', name: 'SATTRING KEEL 4 INCH', icon: '🔧', image: 'sattring-keel-4-inch.webp', desc: 'Extra-long 4-inch concrete shuttering nails for high-load timber structures.' }
];
