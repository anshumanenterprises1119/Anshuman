@echo off
echo ====================================================
echo   ANSHUMAN ENTERPRISES - GIT PUSH SEO CONFIG
echo ====================================================
echo.
...
git commit -m "feat: centralize SEO IDs in seo-config.json, optimize subpage titles & meta descriptions for hardware keywords"
echo.
